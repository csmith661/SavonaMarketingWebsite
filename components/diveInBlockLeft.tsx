    ...
    return(<div className="flex justify-center items-center row-span-3">
          <LeftInViewAnimation position='w-3/5'>
            <div className="text-center">
              ...
              <button className="p-2 transition  active:scale-90 md:hover:scale-110 lg:hover:scale-110 md:active:translate-y-0.5 lg:active:translate-y-0.5  bg-accent text-white rounded-lg">{buttonText}</button>
            </div>
          </LeftInViewAnimation>
