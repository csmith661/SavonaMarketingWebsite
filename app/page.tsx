  ...
  return (
    <>
      ...
      <FrontPageSectionWrapper colorTailwind={'bg-secondary/25'}>
        ...
        <DiveInBlockRight entryTitle='Extend Your Outreach with Viral Marketing' description='Viral Marketing is everything in the business world. From Instagram, Facebook, Threads, and more, we will help you get your message heard.' buttonPath='/services' buttonText='Find Out More' imagePath='/mail.jpg'/>
        
        <DiveInBlockLeft entryTitle='Reach Your Targets with Direct Mailing Services' description='We have expertise in the challenging world of direct mailers. We will extend your message to your clients through excellent mailers.' imagePath="/social.jpg" buttonPath='/mailers' buttonText='View Mailers Portfolio' />
