    ...
    <>
      ...
      <section className="bg-secondary w-full h-full p-4 flex flex-col gap-4 items-center justify-center">
        ...
        <div className="text-center flex justify-content items-center flex-col gap-2">
          ...
          <p className="text-xs">
            Michelle brings years of marketing experience to the table. Her
            areas of emphasis in previous positions have been direct mailing
            marketing, social media marketing, and marketing consulting for many
            companies.
          </p>
        </div>
      </section>
